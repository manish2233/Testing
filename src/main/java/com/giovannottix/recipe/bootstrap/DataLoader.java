package com.giovannottix.recipe.bootstrap;

import com.giovannottix.recipe.domain.*;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.addIngredient(new Ingredient("fresh lime juice or lemon " +
                "juice", new BigDecimal(2), tableSpoonUom));
        guacRecipe.addIngredient(new Ingredient("minced red onion or thinly " +
                "sliced green onion", new BigDecimal(2), tableSpoonUom));
        guacRecipe.addIngredient(new Ingredient("serrano chiles, stems and " +
                "seeds removed, minced", new BigDecimal(2), eachUom));
        ...
        guacRecipe.addIngredient(new Ingredient("ripe tomato, seeds and pulp " +
                "removed, chopped", new BigDecimal(".5"), eachUom));
        ...
        tacosRecipe.addIngredient(new Ingredient("fresh-squeezed orange " +
                "juice", new BigDecimal(3), tableSpoonUom));
        ...
        tacosRecipe.addIngredient(new Ingredient("Roughly chopped cilantro",
                new BigDecimal(4), eachUom));
        tacosRecipe.addIngredient(new Ingredient("cup sour cream thinned with" +
                " 1/4 cup milk", new BigDecimal(4), cupsUom));
